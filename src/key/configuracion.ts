export namespace Configuracion{
  ...
  export const mensajeCambioClave = "Su contraseña ha sido actualizada correctamente. Si no ha sido usted,puede recuperarla ingresando con su correo electronico al sistema de informacion "
}
